...
- [2 GUIコンソールログイン～VM(Ubuntu)導入](2-GUIコンソールログインVM(Ubuntu)導入)
...
2. テンプレ―トを押す
3. 出てくるウインドウの検索窓（右上）でubuntuを検索、数字が大きいものをダウンロード（まあまあ時間かかる）
